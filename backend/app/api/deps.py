...
_INTERACTIVE_DATABASE_ROUTES = frozenset(
    {"/conversations", "/conversations/paginated", "/feedback", "/messages"}
)
...
async def get_db_session(request: Request) -> AsyncGenerator[AsyncSession]:
    ...
    session_scope = (
        ...
        if request.method == "GET" and route_path in _INTERACTIVE_DATABASE_ROUTES
        else get_session
    )
